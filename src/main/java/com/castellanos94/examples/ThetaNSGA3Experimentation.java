...
import com.castellanos94.algorithms.multi.Theta_NSGA_III;
...
public class ThetaNSGA3Experimentation {
    ...
    public static void main(String[] args) throws CloneNotSupportedException, IOException {
        ...
        long averageTime = 0;
        // 1,3
        Theta_NSGA_III<DoubleSolution> algorithm = dtlzTestSuite(numberProblem, numberOfObjectives);
        ...
        range.stream().sequential().forEach(i -> {
            Theta_NSGA_III<DoubleSolution> a = dtlzTestSuite(numberProblem, numberOfObjectives);
    ...
    private static Theta_NSGA_III<DoubleSolution> dtlzTestSuite(int p, int numberOfObjectives) {
        ...
        return new Theta_NSGA_III<>(problem, (int) options.get("pop_size"), maxIterations, selectionOperator,
                (CrossoverOperator<DoubleSolution>) options.get("crossover"),
                (MutationOperator<DoubleSolution>) options.get("mutation"), (int) options.get("pop_size"));
    }
